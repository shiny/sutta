    ...
    <div class="app">
        <div class="py-10 max-w-7xl m-auto">
            <NuxtLink to="/" class="flex my-16">
                <img src="/icon.png" class="w-14 h-14 " />
                <div class="ml-4">
            ...
            <ul class="flex">
                <li>
                    <NuxtLink class="flex transition bg-stone-50 hover:bg-white hover:shadow p-3 rounded" to="/xifangquezhi">
                        <img class="w-16" src="/cover/xifangquezhi.jpg" />
                        <div class="p-3">
        ...
        <footer class="mt-10 w-full border-t">
            <section class="max-w-7xl m-auto text-[13px] py-5 text-gray-500">
                ...
                <ul class="mt-3">
                    ...
                    <li>&copy; 2023 <NuxtLink to="https://github.com/shiny/sutta/"><Icon name="bxl:github" />佛典电子化计划</NuxtLink> GPL-3.0 license </li>
                </ul>
            </section>
        </footer>
    </div>
